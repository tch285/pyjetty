...
################################################################
class PythiaGenVinciaENC(process_base.ProcessBase):

    #---------------------------------------------------------------
    # Constructor
    #---------------------------------------------------------------
    def __init__(self, input_file='', config_file='', output_dir='', debug_level=0, args=None, **kwargs):
        super(PythiaGenVinciaENC, self).__init__(
        ...
        # self.shower_args = []
        # if "vincia" in config.keys():
        #     self.vincia = config['vincia']
        # else:
        #     self.vincia = False

        # if "vincia_tune" in config.keys():
        #     self.vincia_tune = config['vincia_tune']
        #     self.shower_args.append("Vincia:Tune = 0")
        # else:
        #     self.vincia_tune = False

        # if self.vincia:
        #     self.shower_args.append("PartonShowers:model = 2")
        # if self.vincia_tune:
        #     self.shower_args.append("Vincia:Tune = 0")
        # else:
        #     self.shower_args.append("Vincia:Tune = -1")
...
if __name__ == '__main__':
    ...
    process = PythiaGenVinciaENC(config_file=args.config_file, output_dir=args.output_dir, args=args)
