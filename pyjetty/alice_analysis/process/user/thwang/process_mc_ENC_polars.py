...
from pyjetty.alice_analysis.process.user.substructure import process_mc_base_polars
...
################################################################
class ProcessMC_ENC(process_mc_base_polars.ProcessMCBase):
	...
	def calc_phistar(self, p1, p2, q1, q2):
		...
		pt1 = p1.pt()
		pt2 = p2.pt()
		return phi12 + q1*np.arcsin(0.15*Bz*R/pt1) - q2*np.arcsin(0.15*Bz*R/pt2)
